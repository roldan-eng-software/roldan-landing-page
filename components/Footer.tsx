  ...
  const socialLinks = [
    {
      ...
      label: 'LinkedIn de Sandro Roldan',
      icon: (
    ...
    },
    {
      ...
      label: 'GitHub da Roldan Eng Software',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      label: 'Instagram da Roldan Eng Software',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-bg-surface border-t border-border py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="text-lg font-semibold text-text-primary mb-4">Contato</h4>
            <div className="space-y-2">
              ...
              <a
                href="https://wa.me/5516981442301"
                target="_blank"
